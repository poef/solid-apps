...
`;
    ...
    "node_modules/readable-stream/lib/ours/util.js"(exports, module) {
      ...
      var validateAbortSignal = (signal2, name) => {
        if (signal2 !== void 0 && (signal2 === null || typeof signal2 !== "object" || !("aborted" in signal2))) {
          throw new ERR_INVALID_ARG_TYPE(name, "AbortSignal", signal2);
        }
      };
      ...
      module.exports = {
        ...
        addAbortListener: require_events().addAbortListener || function addAbortListener(signal2, listener) {
          if (signal2 === void 0) {
            throw new ERR_INVALID_ARG_TYPE("signal", "AbortSignal", signal2);
          }
        ...
        AbortSignalAny: AbortSignal.any || function AbortSignalAny(signals2) {
          ...
          ac.signal.addEventListener(
            "abort",
            () => {
              signals2.forEach((signal2) => signal2.removeEventListener("abort", abort));
            },
            {
              once: true
            }
    ...
    "node_modules/readable-stream/lib/internal/validators.js"(exports, module) {
      ...
      function validateAbortSignalArray(value, name) {
        ...
        for (let i = 0; i < value.length; i++) {
          ...
          if (signal2 == null) {
            throw new ERR_INVALID_ARG_TYPE(indexedName, "AbortSignal", signal2);
          }
      ...
      function validateSignalName(signal2, name = "signal") {
        ...
        if (signals2[signal2] === void 0) {
          if (signals2[StringPrototypeToUpperCase(signal2)] !== void 0) {
  ...
  var require_legacy = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/legacy.js"(exports, module) {
      ...
      function prependListener(emitter, event2, fn) {
        if (typeof emitter.prependListener === "function") return emitter.prependListener(event2, fn);
        if (!emitter._events || !emitter._events[event2]) emitter.on(event2, fn);
        else if (ArrayIsArray(emitter._events[event2])) emitter._events[event2].unshift(fn);
  ...
  var require_compose = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/compose.js"(exports, module) {
      ...
      module.exports = function compose(...streams) {
        ...
        const head2 = streams[0];
        const tail = pipeline(streams, onfinished);
        const writable = !!(isWritable(head2) || isWritableStream(head2) || isTransformStream(head2));
        const readable = !!(isReadable(tail) || isReadableStream(tail) || isTransformStream(tail));
        d = new Duplex({
          // TODO (ronag): highWaterMark?
          writableObjectMode: !!(head2 !== null && head2 !== void 0 && head2.writableObjectMode),
          readableObjectMode: !!(tail !== null && tail !== void 0 && tail.readableObjectMode),
          writable,
          readable
        });
        if (writable) {
          if (isNodeStream(head2)) {
            d._write = function(chunk, encoding, callback) {
              if (head2.write(chunk, encoding)) {
                callback();
              } else {
                ondrain = callback;
              }
          ...
          } else if (isWebStream(head2)) {
            const writable2 = isTransformStream(head2) ? head2.writable : head2;
  ...
  // src/podlist/node_modules/simplyview/src/activate.mjs
  if (!Symbol.onDestroy) {
  ...
  // src/podlist/node_modules/simplyview/src/action.mjs
  ...
  // src/podlist/node_modules/simplyview/src/route.mjs
  ...
  var SimplyRoute = class {
      ...
      for (let route of this.routeInfo) {
        ...
        if (matches && matches.length) {
          ...
          route.params.forEach((key, i) => {
            ...
            params2[key] = matches[i + 1];
          });
          Object.assign(params2, options);
          args.route = route;
          args.params = params2;
          args = this.runListeners("call", args);
          params2 = args.params ? args.params : params2;
          const searchParams = new URLSearchParams(document.location.search);
          args.result = route.action.call(this.app, params2, searchParams);
    ...
    runListeners(action, params2) {
      ...
      Object.keys(this.listeners[action]).forEach((route) => {
        ...
        if (routeRe.exec(params2.path)) {
          var result2;
          for (let callback of this.listeners[action][route]) {
            result2 = callback.call(this.app, params2);
            if (result2) {
              params2 = result2;
            }
          }
    ...
    handleEvents() {
      ...
      this.app.container.addEventListener("click", (evt) => {
        ...
        if (link && link.pathname && link.hostname == globalThis.location.hostname && !link.link && !link.dataset.simplyCommand) {
          ...
          if (this.has(path2)) {
            let params2 = this.runListeners("goto", { path: path2 });
            if (params2.path) {
              if (this.goto(params2.path)) {
                evt.preventDefault();
                return false;
              }
            }
  ...
  // src/podlist/node_modules/simplyview/src/command.mjs
  var SimplyCommands = class {
    ...
    action(name) {
      ...
      let params2 = Array.from(arguments).slice();
      params2.shift();
      return this.app.actions[name](...params2);
    }
  ...
  // src/podlist/node_modules/simplyview/src/key.mjs
  ...
  // src/podlist/node_modules/simplyview/src/view.mjs
  ...
  // src/podlist/node_modules/simplyview/src/highlight.mjs
  ...
  // src/podlist/node_modules/simplyview/src/app.mjs
  var SimplyApp = class {
    constructor(options = {}) {
        ...
        switch (key) {
          case "html":
            for (const name in options.html) {
              ...
              element2.innerHTML = options.html[name];
          ...
          case "actions":
            ...
            this.action = function(name) {
              ...
              let params2 = Array.from(arguments).slice();
              params2.shift();
              return this.actions[name](...params2);
            };
            break;
          case "view":
  ...
  // src/podlist/node_modules/simplyview/src/include.mjs
  ...
  var include = {
    ...
    html: (html3, link) => {
      let fragment = globalThis.document.createRange().createContextualFragment(html3);
  ...
  var includeLinks = async (links) => {
    ...
    for (let link of remainingLinks) {
      ...
      const response2 = await fetch(link.href);
      if (!response2.ok) {
  ...
  // src/podlist/node_modules/simplyview/src/path.mjs
  var path = {
    get(dataset, pointer) {
    ...
    parents: function(dataset, pointer) {
      ...
      while (pointer) {
        ...
        result2.unshift(pointer);
      }
    }
  };
  var path_default = path;

  // src/podlist/node_modules/simplyview/src/render.mjs
  ...
  // src/podlist/node_modules/simplyview/src/everything.mjs
  var simply2 = {
    activate,
    action: actions,
    app,
  ...
  // src/podlist/node_modules/simplyflow/src/state.mjs
  var state_exports = {};
    ...
    get: (target, property, receiver) => {
      ...
      if (typeof value === "function") {
        if (Array.isArray(target)) {
          return (...args) => {
            let l = target.length;
            let result2 = value.apply(receiver, args);
            if (l != target.length) {
          ...
          return (...args) => {
            let s = target.size;
            let result2 = value.apply(target, args);
            if (s != target.size) {
  ...
  function trace(signal2, prop) {
    const listeners2 = getListeners(signal2, prop);
    return listeners2.map((listener) => {
      return {
  ...
  function effect(fn) {
    ...
    const computeEffect = function computeEffect2() {
      ...
      let result2;
      try {
        result2 = fn(computeEffect2, computeStack, signalStack);
      } finally {
        computeStack.pop();
        signalStack.pop();
        if (result2 instanceof Promise) {
          result2.then((result3) => {
            connectedSignal.current = result3;
          });
        } else {
    ...
    const computeEffect = function computeEffect2() {
      if (lastTick < clock.time) {
        if (hasChanged) {
          ...
          let result2;
          try {
            result2 = fn(computeEffect2, computeStack);
          } finally {
            computeStack.pop();
            if (result2 instanceof Promise) {
              result2.then((result3) => {
  ...
  // src/podlist/node_modules/simplyflow/src/bind.transformers.mjs
  ...
  // src/podlist/node_modules/simplyflow/src/bind.render.mjs
  ...
  // src/podlist/node_modules/simplyflow/src/bind.mjs
  ...
  var SimplyBind = class {
    ...
    applyTemplate(context) {
      ...
      if (!template) {
        let result2 = new DocumentFragment();
        result2.innerHTML = "<!-- no matching template -->";
        return result2;
      }
    ...
    parseLinks(links) {
      ...
      for (let link of links) {
        link = link.split("=");
        result2[link[0].trim()] = link[1].trim();
      }
      return result2;
    }
      ...
      const templateMatches = (t) => {
        ...
        if (path2) {
          if (path2.substr(0, 6) == ":root.") {
            currentItem = getValueByPath(this.options.root, path2);
          } else {
  ...
  // src/podlist/node_modules/simplyflow/src/model.mjs
  var model_exports = {};
  ...
  // src/podlist/node_modules/simplyflow/src/flow.mjs
  ...
  var Graph = class {
    ...
    fullURI(shortURI, separator = null) {
      ...
      const [prefix2, path2] = shortURI.split(separator);
      if (path2) {
        return this.prefixes[prefix2] + path2;
      }
      return shortURI;
    }
      ...
      if (input2.length >= 3) {
        ...
        while ((closingPos = input2.indexOf(opening, closingPos)) > 0) {
          ...
          if (backslashCount % 2 === 0) {
            const raw = input2.substring(openingLength, closingPos);
...
`);
    ...
    extractLists({ remove = false, ignoreErrors = false } = {}) {
      ...
      tails.forEach((tailQuad) => {
        ...
        if (malformed)
          ...
          lists[head2[headPos].value] = items;
      });
      if (remove)
  ...
  // src/components/solid-webid.mjs
...
@media screen and (max-width:719px) {
  ...
  var Path = class _Path {
    #value;
    constructor(path2) {
      this.#value = _Path.collapse(path2);
    }
    get value() {
      return this.#value;
    }
    ...
    static collapse(path2, cwd = "") {
      ...
      if (_Path.isRelative(path2)) {
        path2 = cwd + path2;
      }
      let pathnames = _Path.reduce(path2, (result3, entry) => {
        if (entry == "..") {
          result3.pop();
        } else if (entry !== ".") {
          result3.push(entry);
    ...
    static isAbsolute(path2) {
      ...
      return path2.length && path2[0] === "/";
    }
    static isRelative(path2) {
      return !_Path.isAbsolute(path2);
    }
    static isFolder(path2) {
      if (path2 instanceof _Path) {
        path2 = path2.value;
      }
      return path2.length && path2[path2.length - 1] == "/";
    }
    static isPath(path2) {
      if (path2 instanceof _Path) {
        return true;
      ...
      path2 = path2.trim();
      let u = new URL(path2, document.location);
      return u.pathname == path2;
    }
    static reduce(path2, reducer, initial) {
      if (path2 instanceof _Path) {
        path2 = path2.value;
      }
      return path2.split("/").filter(Boolean).reduce(reducer, initial);
    }
    static map(path2, callback) {
      if (path2 instanceof _Path) {
        path2 = path2.value;
      }
      return path2.split("/").filter(Boolean).map(callback);
    }
    static parent(path2) {
      if (path2 instanceof _Path) {
        path2 = path2.value;
      }
      path2 = path2.split("/").filter(Boolean);
      path2.pop();
      let result2 = "/";
      if (path2.length) {
        result2 += path2.join("/") + "/";
    ...
    static filename(path2) {
      if (path2 instanceof _Path) {
        path2 = path2.value;
      }
      return path2.split("/").filter(Boolean).pop();
    }
    static head(path2) {
      if (path2 instanceof _Path) {
        path2 = path2.value;
      }
      return path2.split("/").filter(Boolean).shift();
    }
    static tail(path2) {
      if (path2 instanceof _Path) {
        path2 = path2.value;
  ...
  var FileSystem = class _FileSystem {
    ...
    cd(path2) {
      if (!(path2 instanceof Path)) {
        path2 = new Path(Path.collapse(path2, this.#path));
      }
      return new _FileSystem(this.#adapter.cd(path2));
    }
    async read(path2, reader = null) {
      if (!(path2 instanceof Path)) {
        path2 = new Path(Path.collapse(path2, this.#path));
      }
      if (typeof reader === "function") {
        ...
        return this.#adapter.readStream(path2, reader);
      } else {
    ...
    async write(path2, contents, metadata = null) {
      ...
      if (typeof contents === "function") {
        ...
        return this.#adapter.writeStream(path2, contents, metadata);
      } else if (typeof contents === "string") {
        return this.#adapter.write(path2, contents, metadata);
      } else {
    ...
    async delete(path2) {
      ...
      return this.#adapter.delete(path2);
    }
    async exists(path2) {
      if (!(path2 instanceof Path)) {
        path2 = new Path(Path.collapse(path2, this.#path));
    ...
    if (pattern === Boolean) {
      ...
      for (let p of pattern) {
        for (let index of data.keys()) {
          let problem = fails(data[index], p, root, path2 + "[" + index + "]");
          if (Array.isArray(problem)) {
            problems = problems.concat(problem);
          } else if (problem) {
            problems.push(problem);
      ...
      if (Array.isArray(data)) {
        ...
        if (pattern instanceof Function) {
          let result2 = fails(data, pattern, root, path2);
          if (result2) {
            problems = problems.concat(result2);
          }
        } else {
          for (const [patternKey, subpattern] of Object.entries(pattern)) {
            let result2 = fails(data[patternKey], subpattern, root, path2 + "." + patternKey);
            if (result2) {
              problems = problems.concat(result2);
            }
          }
  ...
  function dpopmw(options) {
    ...
    return async (req, next) => {
      const keys2 = await keysStore();
      let keyInfo = await keys2.get(options.site);
      if (!keyInfo) {
  ...
  var SolidAdapter = class extends HttpAdapter {
    ...
    async list(path2) {
      ...
      if (result2.data) {
        ...
        throw new Error(path2 + " could not be parsed", { cause: result2 });
      }
    }
  };

  // src/components/solid-fs.mjs
