...
<div class="solid-contacts-contact ds-sticky-top" style="--ds-top: 2em;">
  ...
  // node_modules/@muze-nl/theds/dist/theds.mjs
  var theds = {
    css: {
...
`);
      ...
      "dsInitDropdown": async function() {
        simply.activate.addListener("ds-dropdown", function() {
          const nav = this.querySelector(".ds-dropdown-nav"), input2 = this.querySelector(".ds-dropdown-state"), r = new Uint32Array(8);
          ...
          if (document.body.showPopover) {
            ...
            input2.outerHTML = '<button class="ds-dropdown-state" popovertarget="' + id + '"></button>';
          }
        });
      }
    },
  ...
  var contacts = simply.app({
    actions: {
      loadMockContacts: async function() {
        const contacts2 = await this.api.contacts();
        const contactsModel = simply.flow.model({
          data: contacts2.persons,
          options: {}
        });
